...
import com.example.youzhedou.order_food_app_server_side.Common.DirectionJSONParser;
...

{
    ...
    private IGeoCoordinates mGeoService;
    ...
    private void drawRoute(final LatLng yourLocation, String address) {
        mGeoService.getGeoCode(address).enqueue(new Callback<String>() {
            @Override
            public void onResponse(Call<String> call, Response<String> response) {
                try{
                    ...
                    MarkerOptions marker = new MarkerOptions().icon(BitmapDescriptorFactory.fromBitmap(bitmap))
                            .title("Order of " +Common.currentRequest.getTel())
                            .position(orderLocation);
                    mMap.addMarker(marker);

                    //draw route
                    mGeoService.getDirections(yourLocation.latitude+","+yourLocation.longitude,
